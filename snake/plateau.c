...
void placer_fruit(plateau *p)
{
    ...
    while (p->position_case[randomPosX][randomPosY].fruit &&
            !p->position_case[randomPosX][randomPosY].snake &&
            !p->position_case[randomPosX][randomPosY].obstacle &&
            !p->position_case[randomPosX][randomPosY].vide);
