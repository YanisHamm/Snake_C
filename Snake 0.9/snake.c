...
void snake_position_initial(snake *s,plateau* p)
{
    ...
    p->position_case[randomPosY][randomPosX].idsnake=s->thread_id;
...
void change_sens_ia(snake *s,plateau *p)
{
    if(s->element_tete.emplacement_element.x-p->cible_fruit.x>0)
    {
        ...
        if(p->position_case[s->element_tete.emplacement_element.x-1][s->element_tete.emplacement_element.y].vide)
        {
            s->sens='q'; // gauche
            return;
        }
    ...
    if(s->element_tete.emplacement_element.x-p->cible_fruit.x==0)
    {
        ...
        {
            if(p->position_case[s->element_tete.emplacement_element.x][s->element_tete.emplacement_element.y+1].vide)
            {
                s->sens='z';
                return;
            }
        ...
        if(s->element_tete.emplacement_element.y-p->cible_fruit.y<0)
        {
            if(p->position_case[s->element_tete.emplacement_element.x-1][s->element_tete.emplacement_element.y-1].vide)
            {
                s->sens='s';
                return;
            }
