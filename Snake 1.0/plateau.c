...
void remplir_plateau(plateau *p)
{
    ...
    case 3:
        ...
        p->position_case[2][2].snake=false;
        p->position_case[2][2].fruit=false;

        p->position_case[2][3].obstacle=true;
        p->position_case[2][3].vide=false;
        p->position_case[2][3].snake=false;
        p->position_case[2][3].fruit=false;


        p->position_case[3][3].obstacle=true;
        p->position_case[3][3].vide=false;
        p->position_case[3][3].snake=false;
        p->position_case[3][3].fruit=false;

        p->position_case[3][2].obstacle=true;
        p->position_case[3][2].vide=false;
        p->position_case[3][2].snake=false;
        p->position_case[3][2].fruit=false;

        p->position_case[2][p->largeur-2-1].obstacle=true;
        p->position_case[2][p->largeur-2-1].vide=false;
        p->position_case[2][p->largeur-2-1].snake=false;
        p->position_case[2][p->largeur-2-1].fruit=false;

        p->position_case[2][p->largeur-3-1].obstacle=true;
        p->position_case[2][p->largeur-3-1].vide=false;
        p->position_case[2][p->largeur-3-1].snake=false;
        p->position_case[2][p->largeur-3-1].fruit=false;

        p->position_case[3][p->largeur-3-1].obstacle=true;
        p->position_case[3][p->largeur-3-1].vide=false;
        p->position_case[3][p->largeur-3-1].snake=false;
        p->position_case[3][p->largeur-3-1].fruit=false;
        ...
        p->position_case[3][p->largeur-2-1].snake=false;
        p->position_case[3][p->largeur-2-1].fruit=false;
        ...
        p->position_case[p->hauteur-2-1][p->largeur-2-1].snake=false;
        p->position_case[p->hauteur-2-1][p->largeur-2-1].fruit=false;


        p->position_case[p->hauteur-2-1][p->largeur-3-1].obstacle=true;
        p->position_case[p->hauteur-2-1][p->largeur-3-1].vide=false;
        p->position_case[p->hauteur-2-1][p->largeur-3-1].snake=false;
        p->position_case[p->hauteur-2-1][p->largeur-3-1].fruit=false;


        p->position_case[p->hauteur-3-1][p->largeur-3-1].obstacle=true;
        p->position_case[p->hauteur-3-1][p->largeur-3-1].vide=false;
        p->position_case[p->hauteur-3-1][p->largeur-3-1].snake=false;
        p->position_case[p->hauteur-3-1][p->largeur-3-1].fruit=false;


        p->position_case[p->hauteur-3-1][p->largeur-2-1].obstacle=true;
        p->position_case[p->hauteur-3-1][p->largeur-2-1].vide=false;
        p->position_case[p->hauteur-3-1][p->largeur-2-1].snake=false;
        p->position_case[p->hauteur-3-1][p->largeur-2-1].fruit=false;

        p->position_case[p->hauteur-2-1][2].obstacle=true;
        p->position_case[p->hauteur-2-1][2].vide=false;
        p->position_case[p->hauteur-2-1][2].snake=false;
        p->position_case[p->hauteur-2-1][2].fruit=false;


        p->position_case[p->hauteur-2-1][3].obstacle=true;
        p->position_case[p->hauteur-2-1][3].vide=false;
        p->position_case[p->hauteur-2-1][3].snake=false;
        p->position_case[p->hauteur-2-1][3].fruit=false;


        p->position_case[p->hauteur-3-1][3].obstacle=true;
        p->position_case[p->hauteur-3-1][3].vide=false;
        p->position_case[p->hauteur-3-1][3].snake=false;
        p->position_case[p->hauteur-3-1][3].fruit=false;


        p->position_case[p->hauteur-3-1][2].obstacle=true;
        p->position_case[p->hauteur-3-1][2].vide=false;
        p->position_case[p->hauteur-3-1][2].snake=false;
        p->position_case[p->hauteur-3-1][2].fruit=false;
